import { Modal, Text, StyleSheet, View, TouchableOpacity, Switch, TextInput, Alert, Platform } from "react-native-web"
...
export default function ModalScreen(){
  ...
  const botonCerrar = () => {setModalVisible(false); setDescripcion(''); setNumFav(''); setGasto(true);}; 
